...
En el gráfico se puede observar que paises con un PIB per capita más alto pueden contar con una expectativa de vida más alta. Esto guarda relación con el PIB per capita, el cual indica el nivel de desarrollo economico de un país. Entre mejor sean los niveles de PIB percapita esto es porque hay una tendencia a tener mejores sistemas de salud, acceso a la educación y mejores niveles de nutrición poblacional.

Se presentan algunas excepciones como Cuba, Costa Rica o Chile debido a que estos países han invertido considerablemente en su sistema de salud y educación, contribuyendo a mejorar la salud de su población.

Alineandonos con lo establecido por el PIB per capita y su relación con la esperanza de vida, se puede manifestar que los paises desarrollados puedan contar con una mejor expectativa de vida que los paises en desarrollo.
